...
function buildOrderEmailText(order: AdminOrderDetail): string {
  ...
  return [
    ...
    "Our marine team will confirm product availability and payment details before dispatch.",
    "",
    "Order summary:",
    itemLines,
    "",
